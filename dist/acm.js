...
let getFormData = async () => {
  let locale = await osLocale(); // 如果本机语言不是中文，则显示英文
  ...
  return [{
    ...
    loop: false,
    choices: [{
      name: `feat:     ${txt_config.feat[locale]}`,
      value: 'feat',
      short: 'feat'
    }, {
      name: `fix:      ${txt_config.fix[locale]}`,
      value: 'fix',
      short: 'fix'
    }, {
      name: `perf:     ${txt_config.perf[locale]}`,
      value: 'perf',
      short: 'perf'
    }, {
      name: `refactor: ${txt_config.refactor[locale]}`,
      value: 'refactor',
      short: 'refactor'
    }, {
      name: `merge:    ${txt_config.merge[locale]}`,
      value: 'merge',
      short: 'merge'
    }, {
      name: `docs:     ${txt_config.docs[locale]}`,
      value: 'docs',
      short: 'docs'
    }, {
      name: `style:    ${txt_config.style[locale]}`,
      value: 'style',
      short: 'style'
    }, {
      name: `test:     ${txt_config.test[locale]}`,
      value: 'test',
      short: 'test'
    }, {
      name: `build:    ${txt_config.build[locale]}`,
      value: 'build',
      short: 'build'
    }, {
      name: `revert:   ${txt_config.revert[locale]}`,
      value: 'revert',
      short: 'revert'
    }, {
      name: `ci:       ${txt_config.ci[locale]}`,
      value: 'ci',
      short: 'ci'
    }, {
      name: `chore:    ${txt_config.chore[locale]}`,
      value: 'chore',
      short: 'chore'
    }, {
      name: `release:  ${txt_config.release[locale]}`,
      value: 'release',
      short: 'release'
    }, {
      name: `workflow: ${txt_config.workflow[locale]}`,
      value: 'workflow',
      short: 'workflow'
    }],
    prefix: '1.'
